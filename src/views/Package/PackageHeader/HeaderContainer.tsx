...
const lgGridAreas = makeGridAreas(
  [GRID_AREAS.HEADING, GRID_AREAS.LANGUAGES, GRID_AREAS.META],
  [GRID_AREAS.HEADING, GRID_AREAS.INSTALL, GRID_AREAS.META]
);
...
export const HeaderContainer: FunctionComponent = ({ children }) => (
  <Grid
    ...
    templateColumns={{ base: "1fr", lg: "1fr 14rem 15rem" }}
