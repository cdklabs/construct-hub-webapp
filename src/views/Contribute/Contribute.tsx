      ...
      <Accordion allowMultiple allowToggle defaultIndex={[0]}>
        <FAQItem question="How can I add my construct to Construct Hub?">
          <Stack spacing={4}>
            ...
            <Text>
              ...
              languages, your library *must* be compiled with{" "}
        ...
        <FAQItem question="What are the best practices for improving discoverability of a construct library on Construct Hub?">
          <Stack spacing={4}>
            ...
            <OrderedList pl={8} sx={{ li: { mt: 4 } }}>
              <ListItem>
                <strong>Helpful description.</strong> Publish your library with
                a description. Libraries without description have lower chances
                to be discovered by users. When you write your library’s
                description, think: Why would someone use it? What makes it
                unique? Make the description as accurate and differentiated as
                possible.
              </ListItem>

              <ListItem>
                <strong>Helpful keywords.</strong> Publish your library with
                helpful keywords, ones that can help potential users to find
                your package. Helpful keywords can be technologies that are
                being used by the library, use cases the library is useful for,
                service names that are being used by the library etc. For
                example: ‘Monitoring’, ‘Kubernetes’, ‘Cost Management’,
                ‘Websites’, ‘AI’, ‘Containers’ and more.
              </ListItem>
              ...
              <ListItem>
                ...
                make it easy to get started with your library? Does it explain
                how your library is different from other libraries? Is it easy
                to understand at first glance the value developers gain from the
                library? For more information see *“Q: What are the best
                practices for a developer-friendly README file?”.*
              </ListItem>

              <ListItem>
                <strong>API documentation.</strong> Document the library
                classes, methods, properties in the library’s code. Construct
                Hub will display this information when it automatically
              ...
              <ListItem>
                ...
                shows that successful libraries are those where publishers
                engage and collaborate with the user community, respond to
                issues and pull requests, fix bugs, and add capabilities. To
                gain more developers trust, maintain the releases section on
                your code repository and make sure to describe the changes
                between different releases. You may consider to link the
                libraries you’ve published with your code repository.
              </ListItem>

              <ListItem>
                <strong>Amazon Partner Network (APN) badge.</strong> If you’re
                an AWS partner and you are publishing a library for your
                service, please reach out to us and we will be happy to add a
                badge to your libraries with your company’s name.
              </ListItem>
              ...
              <ListItem>
                ...
                in TypeScript, JSII will create packages in the other CDK
                programming languages. Construct Hub will then automatically
                generate API reference and transliterate code samples. All you
                need to do is to follow the instructions under *“Q: How can I
                add my construct to Construct Hub?”.*
              </ListItem>

              <ListItem>
                <strong>
                  Mention official names of technologies and services your’e
          ...
          <Stack spacing={4}>
            ...
            <UnorderedList pl={8} sx={{ li: { mt: 4 } }}>
              ...
              <ListItem>
                ...
                Which use case does it solve? Which technologies and services
                does it use or support?
              </ListItem>
              ...
              <ListItem>
                ...
                reading code samples before anything else. Write your code
                samples in TypeScript, and Construct Hub will transliterate them
                to the other programming languages your library supports. A good
                practice is to include a minimal code sample of how to use your
                library in the first page of your README.
              </ListItem>

              <ListItem>
                <strong>Author information.</strong> Share information about
                you, other packages you’ve published, and additional helpful
                links that can improve your credibility with readers.
              </ListItem>

              <ListItem>
                <strong>License and support.</strong> Include a “License” and
                “Contributing” sections that invite users to contribute via
                links to your source code repository and issue tracker.
                (Construct Hub provides these links in your library’s package
                page, but it’s convenient to have them in the README too.)
              </ListItem>
              ...
              <ListItem>
                ...
                videos that can help potential customers engage with your
                library.
              </ListItem>
