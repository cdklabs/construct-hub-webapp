...
aws_cdk.aws_secretsmanager.CfnResourcePolicy(scope: constructs.Construct, id: string, 
    resourcePolicy: any, 
    secretId: string, 
...
aws_cdk.aws_secretsmanager.CfnRotationSchedule(scope: constructs.Construct, id: string, 
    secretId: string, 
...
aws_cdk.aws_secretsmanager.CfnSecret(scope: constructs.Construct, id: string, 
...
aws_cdk.aws_secretsmanager.CfnSecretTargetAttachment(scope: constructs.Construct, id: string, 
    secretId: string, 
    targetId: string, 
    targetType: string)
```
...
aws_cdk.aws_secretsmanager.ResourcePolicy(scope: constructs.Construct, id: string, 
...
aws_cdk.aws_secretsmanager.RotationSchedule(scope: constructs.Construct, id: string, 
...
aws_cdk.aws_secretsmanager.Secret(scope: constructs.Construct, id: string, 
    description: string = None, 
...
```python
secret.addRotationSchedule(id: string, 
    automaticallyAfter: aws-cdk-lib.Duration = None, 
    hostedRotation: aws-cdk-lib.aws_secretsmanager.HostedRotation = None, 
    rotationLambda: aws-cdk-lib.aws_lambda.IFunction = None)
```
...
aws_cdk.aws_secretsmanager.SecretRotation(scope: constructs.Construct, id: string, 
...
aws_cdk.aws_secretsmanager.SecretTargetAttachment(scope: constructs.Construct, id: string, 
    secret: aws-cdk-lib.aws_secretsmanager.ISecret)
```
...
```python
secrettargetattachment.addRotationSchedule(id: string, 
    automaticallyAfter: aws-cdk-lib.Duration = None, 
    hostedRotation: aws-cdk-lib.aws_secretsmanager.HostedRotation = None, 
    rotationLambda: aws-cdk-lib.aws_lambda.IFunction = None)
```
...
```python
secrettargetattachment.denyAccountRootDelete()
```
