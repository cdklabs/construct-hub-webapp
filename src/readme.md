...
### EksOptimizedImage <a name="aws-cdk-lib.aws_eks.EksOptimizedImage"></a>

- *Implements:* [`aws_cdk.aws_ec2.IMachineImage`](#aws-cdk-lib.aws_ec2.IMachineImage)

Construct an Amazon Linux 2 image from the latest EKS Optimized AMI published in SSM.

#### Initializer <a name="aws-cdk-lib.aws_eks.EksOptimizedImage.Initializer"></a>
...
##### `get_image` <a name="get_image"></a>

```python
def get_image(scope: constructs..Construct)
```
...
### EndpointAccess <a name="aws-cdk-lib.aws_eks.EndpointAccess"></a>
...
##### `only_from` <a name="only_from"></a>

```python
def only_from(cidr: builtins.str)
```

###### `cidr`<sup>Required</sup> <a name="cidr"></a>
...
##### `PUBLIC_AND_PRIVATE` <a name="PUBLIC_AND_PRIVATE"></a>
...
### KubernetesVersion <a name="aws-cdk-lib.aws_eks.KubernetesVersion"></a>
